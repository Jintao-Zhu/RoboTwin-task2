...
def get_args_parser():
    ...
    # RLAS args (not used by DETR; kept to avoid argparse errors)
    parser.add_argument("--enable_rlas", action="store_true")
    parser.add_argument("--rlas_warmup_updates", action="store", type=int, required=False, default=10000)
    parser.add_argument("--rlas_update_interval", action="store", type=int, required=False, default=10000)
    parser.add_argument("--rlas_temperature", action="store", type=float, required=False, default=1.0)
    parser.add_argument("--rlas_epsilon_mix", action="store", type=float, required=False, default=0.1)
